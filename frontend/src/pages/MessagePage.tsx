...
function MessagePage() {
  ...
  useEffect(() => {
    ...
    const isLastMessageChanged = lastMessage.id !== lastMessageIdRef.current;
                            ...
                            <div className="flex flex-col gap-2 mb-2">
                              {message.attachments.map((att) => {
                                  ...
                                  return (
                                    ...
                                    >
                                      ...
                                      <a
                                        ...
                                        title="Download"
                                        onClick={(e) => e.stopPropagation()} // Prevent image clicking
                                      >
                                        <svg
                                ...
                                return (
                                  <a
                                    key={att.id}
                                    href={att.urlDownload} // Direct download link
                      ...
                      <>
                        ...
                        <div className="flex flex-row border-b border-gray-200">
                          ...
                          <Button
                            ...
                            sx={{
                              fontWeight:
                                detailView === "media" ? "bold" : "semibold",
                              color: "black",
                              width: "100%",
                              textAlign: "center",
                              padding: "12px 0",
