          ...
          <div className="flex justify-center mb-16">
            <div className="relative group">
              ...
              <Button
                ...
                startDecorator={<Favorite sx={{ fontSize: "2rem" }} />}
                endDecorator={<TrendingUp sx={{ fontSize: "1.5rem" }} />}
                sx={{
                  position: "relative",
                  background:
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600">
                          {profile.bio?.substring(0, 50) || "No bio available"}
                          ...
                        </p>
            ...
            <div className="w-full bg-gradient-to-br from-white to-pink-50 rounded-3xl p-10 shadow-md border border-pink-100">
              ...
              {isLoading ? (
                  ...
                  {requestProfiles.map((profile, index) => (
                    ...
                    >
                      ...
                      <div className="flex gap-2">
                        ...
                        <button
                          onClick={() => handleRejectRequest(profile.uid)}
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-base text-gray-500">
                    Start matching to receive work date requests!
                  </p>
                </div>
              )}
            </div>
